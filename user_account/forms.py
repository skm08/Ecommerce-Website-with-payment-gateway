...
class ChangePasswordForm(forms.Form):
    ...
    def __init__(self, user, *args, **kwargs):
        ...
        self.fields['current_password'].widget.attrs.update({"placeholder": "Type current password"})
        self.fields['new_password1'].widget.attrs.update({"placeholder": "Type New password"})
